...
public class PasswordResetToken {
    ...
    //Senaryo
    //Kullanýcý passwordunu deðiþtirmek istediginde kullanýcýn emailina 24 saat gecerli bir token yollayacagýz.
    //Kullanýcý 24 saat içinde url týklarsa hesap login olucak password deðiþtirme formu gelecek. 
